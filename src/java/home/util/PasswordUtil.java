 ...
 * This code is reproduced from Murach's Java servlets and JSP 
 * 3rd Edition
 * This code uses SHA-256. If this algorithm isn't available, we can try a weaker
 * level of encryption such as SHA-128
 */
