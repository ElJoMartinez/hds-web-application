...
<div class="main main-raised" id="main-raised">
    <div class="container">
        <div class="section text-center section-landing">
            <div class="row">
                <div class="profile" >
                    <div class="avatar" id="icon-image">
                        <img src="/images/info-icon.png" alt="Circle Image" class="img-circle img-responsive img-raised">
                    </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h3 class="description" id="para">
                        <strong>B</strong>eginning as a small remodeling company, 
                        ...
                        bathroom layouts. </h3>
                    <h3 class="description" id="para">
                       <strong>T</strong>his was the AHA moment for Emily and Joe in that they were 
                    ...
                    <h3 class="description" id="para">
                        <strong>A</strong>fter applying and receiving a business license, 
                    ...
                    <h3 class="description" id="para">
                        <strong>N</strong>ow, after expanding to a total of five locations,
                        HDS employs a team of 38 spanning all stores serving
                        our customers with a faster turn around time giving us
                        the ability to provide our services at a larger volume
                        covering broader distances. 
                    </h3>
